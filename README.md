...
## NSCollectionView & NSTableViewDiffableDataSource isDeletable
`isDeletable` enables deleting of items and rows via backspace.
 ```
 diffableCollectionViewDataSource.isDeletable = true
 ```
